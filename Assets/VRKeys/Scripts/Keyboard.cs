...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
		...
		public TextMeshProUGUI showingDisplay;


        private void Start()
        {
			showingDisplay.text = networkRoomManager.networkAddress;
		}
        /// <summary>
        /// Initialization.
        /// </summary>
        ...
        //	playerSpace.transform.SetParent(targetRig.transform);
        //	//playerSpace.transform.localPosition = new Vector3(-0.04000008f, -1.239f, 1.11f);
        //	//playerSpace.transform.localEulerAngles = new Vector3(-58.927f,0,0);
        //	playerSpace.transform.localPosition = new Vector3(0, 0.069f, 1.644f);
        //	playerSpace.transform.localEulerAngles = Vector3.zero;
        ...
        //	leftHand.transform.SetParent(targetLeftHand.transform);
        //	leftHand.transform.localPosition = Vector3.zero;
        //
        //	rightHand = new GameObject ("Right Hand");
        //	rightHand.transform.SetParent(targetRightHand.transform);
        ...
        private void PositionAndAttachMallets () {
			...
			leftMallet.transform.localEulerAngles = new Vector3(90, 0, 0);
			...
			rightMallet.transform.localEulerAngles = new Vector3(90, 0, 0);
		...
		private IEnumerator SetupKeys () {
			...
			text = networkRoomManager.networkAddress;
			showingDisplay.text = "Offline\nNetwork IP = "+ text;
		}
		...
		private void UpdateDisplayText () {
			...
			networkRoomManager.networkAddress = display;
			showingDisplay.text = "Offline\nNetwork IP = " + display;
		}
