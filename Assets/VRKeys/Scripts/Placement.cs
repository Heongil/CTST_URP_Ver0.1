...
namespace VRKeys {
	...
	public class Placement : MonoBehaviour {
		...
		void Awake () {
			...
			keyboard.keyboardWrapper.transform.localPosition = new Vector3(0, -0.231f, -1.17f); //settings.position;
			keyboard.keyboardWrapper.transform.localEulerAngles = new Vector3(-22.661f, 0, 0);
			keyboard.keyboardWrapper.transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
