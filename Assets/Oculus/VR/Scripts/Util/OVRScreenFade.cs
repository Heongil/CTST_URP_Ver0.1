...
public class OVRScreenFade : MonoBehaviour
{
	...
	public Color[] eventColors = { Color.black, Color.red, Color.green,Color.white,Color.yellow };
	public void ScreenFade(string sAeAfC)
    {
		string[] velues = sAeAfC.Split(',');
		fadeTime = float.Parse(velues[2]);
		fadeColor = eventColors[int.Parse(velues[3])];
		StartCoroutine(Fade(1, 0));
	}
